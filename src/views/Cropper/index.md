...
<script>
import imgSrc from "@/assets/images/CssTricks/bg1.jpg"
...
export default {
  ...
  data() {
    return {
      ...
      filElem: null,
      imgSrc,
      // imgSrc: "https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/81de421e98cc45dab6d8fcc87aef7f08~tplv-k3u1fbpfcp-watermark.image",
      cropImg: null,
      cropShotImg: null,
      flipY: null,
      flipX: null
  ...
  methods: {
    ...
    handleShot() {
      this.cropShotImg = this.$refs.cropper.getCroppedCanvas().toDataURL()
      console.log("cropShotImg",this.cropShotImg)
    },
    openFile() {
    ...
    chooseImage() {
      console.log('ref-->', this.$refs.filElem);
    ...
    handleSave() {
      console.log('cropImg.value', this.cropImg)
      this.downloadFileByBase64(this.cropImg, 'cropImg')
    }
  },
}
</script>
